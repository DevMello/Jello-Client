...
public class GuiVideoSettings extends GuiScreen
{
    ...
    public void drawScreen(int x, int y, float z)
    {
        ...
        boolean InDevolpment = true;
        String DevVerInDev = "Dev Beta v1.1.1 Devolpment Build";
        ...
        int lenDev = this.fontRendererObj.getStringWidth(DevVerInDev);
        if(InDevolpment) {
            this.drawString(this.fontRendererObj, DevVerInDev, this.width - lenDev - 2, this.height - 10, 8421504);
        }
        ...
        this.drawString(this.fontRendererObj, verMc, 5, FontUtil.jelloFont.getHeight() + 1, 8421504);
