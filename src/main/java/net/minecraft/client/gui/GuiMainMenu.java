...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
        if(Vars.firstLaunch) {
            NotificationManager.notify("Hello!Welcome To Dev Client!", "Press Right Shift On Your Keyboard", 12000);
    ...
    public void go() throws IOException {
        ...
        try {
            ...
            playerCount = getContentFromResponse(response);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        FontUtil.jelloFont.drawNoBSString("© Dev Client v1.1 by DevMello", 5, sr.getScaledHeight() - 5 - FontUtil.jelloFont.getHeight() + 1, -1);
        FontUtil.jelloFont.drawNoBSString("Changelog", 5, FontUtil.jelloFont.getHeight() + 1, -1);
        FontUtil.jelloFont.drawNoBSString("Minecraft 1.8.9(Jello Based)", sr.getScaledWidth() - 5 - 0.5f - FontUtil.jelloFont.getStringWidth("Minecraft 1.8.9(Jello Based)") + 1, sr.getScaledHeight() - 5 - FontUtil.jelloFont.getHeight() + 1, -1);
        FontUtil.jelloFont.drawNoBSString("Players online: " + playerCount, sr.getScaledWidth() - 5 - 0.5f - FontUtil.jelloFont.getStringWidth("Players online: " + playerCount) + 1, FontUtil.jelloFont.getHeight() + 1, -1);
        ...
        if(isMouseHoveringRect1(5,  FontUtil.jelloFont.getHeight() + 1, 67/2f, 19/2f, mouseX, mouseY) && !addAltPrompt){
            if(addAnimation > 0){
        ...
        if(addAnimation < 16.5f){
            this.drawFloatRect(5 + addAnimation,  FontUtil.jelloFont.getHeight() + 13, FontUtil.jelloFont.getStringWidth("Changelog") + 5 - addAnimation,  FontUtil.jelloFont.getHeight() + 14, -1);
            //sr.getScaledWidth() - 22/2f - addAnimation
        }
