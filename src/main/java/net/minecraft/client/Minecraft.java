...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    //Dev
    private static final ResourceLocation locationMojangPng = new ResourceLocation("textures/gui/title/mainmenubg1.png");
    ...
    private void func_175609_am() throws LWJGLException
    {
        ...
        Display.setTitle(/*"Minecraft 1.8"*/"Dev 1.1");
