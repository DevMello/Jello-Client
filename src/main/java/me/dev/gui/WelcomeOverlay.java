...
public class WelcomeOverlay extends GuiScreen {
    ...
    public void initGui()
    {
        ...
        GuiMainMenu PlayerCount = new GuiMainMenu();
        //name = message;
        pe.particles.clear();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        FontUtil.jelloFont.drawNoBSString("© Jello Client v1.1 by MentalFrostByte/Remade by DevMello", 5, sr.getScaledHeight() - 5 - FontUtil.jelloFont.getHeight() + 1, -1);
        //FontUtil.jelloFont.drawNoBSString("Changelog", 5, FontUtil.jelloFont.getHeight() + 1, -1);
        FontUtil.jelloFont.drawNoBSString("Minecraft 1.8.9", sr.getScaledWidth() - 5 - 0.5f - FontUtil.jelloFont.getStringWidth("Minecraft 1.8.9") + 1, sr.getScaledHeight() - 5 - FontUtil.jelloFont.getHeight() + 1, -1);
        ...
        if(zoom1 > 1){
            ...
            GlStateManager.translate(-(offset + 32), -(height + 64), 0);
            FontUtil.jelloFontScale.drawNoBSString("PvP Client", offset + 32 - FontUtil.jelloFontScale.getStringWidth("PvP Client")/2 + 0.5f, height + 140/2 + 1 - 4, new Color(100/255f ,100/255f ,100/255f, Math.max(0, Math.min(1, 0.5f+(zoom1-1)*2.5f))).getRGB());
        }
        GlStateManager.popMatrix();
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("Jello/empty.png"));
        GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER, GL11.GL_LINEAR);
        GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MAG_FILTER, GL11.GL_LINEAR);
        this.drawModalRectWithCustomSizedTexture(offset, height, 0, 0, 64, 64, 64, 64);
        GlStateManager.popMatrix();
        ...
        if(zoom2 > 1){
            ...
            GlStateManager.translate(-(offset + 32), -(height + 64), 0);
            FontUtil.jelloFontScale.drawNoBSString("", offset + 32 - FontUtil.jelloFontScale.getStringWidth("Multiplayer")/2 + 0.5f, height + 140/2 + 1 - 4, new Color(100/255f ,100/255f ,100/255f, Math.max(0, Math.min(1, 0.5f+(zoom2-1)*2.5f))).getRGB());
        }
        GlStateManager.popMatrix();
        ...
        if(zoom3 > 1){
            ...
            GlStateManager.translate(-(offset + 32), -(height + 64), 0);
            FontUtil.jelloFontScale.drawNoBSString("", offset + 32 - FontUtil.jelloFontScale.getStringWidth("Connect")/2 + 0.5f, height + 140/2 + 1 - 4, new Color(100/255f ,100/255f ,100/255f, Math.max(0, Math.min(1, 0.5f+(zoom3-1)*2.5f))).getRGB());
        }
        GlStateManager.popMatrix();
        ...
        if(zoom4 > 1){
            ...
            GlStateManager.translate(-(offset + 32), -(height + 64), 0);
            FontUtil.jelloFontScale.drawNoBSString("", offset + 32 - FontUtil.jelloFontScale.getStringWidth("")/2 + 0.5f, height + 140/2 + 1 - 4, new Color(100/255f ,100/255f ,100/255f, Math.max(0, Math.min(1, 0.5f+(zoom4-1)*2.5f))).getRGB());
        }
        GlStateManager.popMatrix();
        ...
        if(zoom5 > 1){
            ...
            GlStateManager.translate(-(offset + 32), -(height + 64), 0);
            FontUtil.jelloFontScale.drawNoBSString("Utility Client", offset + 32 - FontUtil.jelloFontScale.getStringWidth("Utility Client")/2 + 0.5f, height + 140/2 + 1 - 4, new Color(100/255f ,100/255f ,100/255f, Math.max(0, Math.min(1, 0.5f+(zoom5-1)*2.5f))).getRGB());
        }
        GlStateManager.popMatrix();
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        if(mouseButton == 0){
            ...
            if(this.isMouseHoveringRect1(offset + 190, height + 4, 64-8, 64-8, mouseX, mouseY)){
                Vars.version = "Hacks";
                mc.displayGuiScreen(new GuiMainMenu());
                System.out.println(Vars.version);
                Vars.firstLaunch = true;
